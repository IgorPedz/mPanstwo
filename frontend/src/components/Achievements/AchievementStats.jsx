        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
          <div className="flex items-center gap-6 min-w-[300px] w-full lg:w-auto">
            <div className="relative shrink-0">
              <div
                className="w-24 h-24 rounded-full flex items-center justify-center text-white shadow-2xl shadow-blue-500/40 color-transition"
            ...
            <div>
              ...
              <p className="text-slate-500 mt-2 font-medium color-transition">
                {t("achievements.totalReputation")}{" "}
                <span className="color-transition text-blue-600 dark:text-blue-400">
                  {currentLevel.totalPoints.toLocaleString()}{" "}
                  {t("achievements.reputation")}
                </span>
              </p>
            </div>
          </div>
          <div className="flex-1 w-full space-y-4">
            <div className="flex justify-between items-end">
              <span className="text-xs font-bold uppercase tracking-widest text-slate-400 color-transition">
                {t("achievements.progressTo")}{" "}
                {t(`achievements.ranks.${currentLevel.nextName.trim()}.name`)}
              </span>
