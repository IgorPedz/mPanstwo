const NotificationsHeader = ({ onClearAll }) => (
  <header className="mb-12 flex items-center justify-between">
    <div>
      ...
      <p className="text-slate-400 font-medium color-transition">
        Log zdarzeń parlamentarnych i systemowych
      </p>
    </div>
    <button
      onClick={onClearAll}
      className="text-xs font-bold uppercase tracking-widest text-blue-600 border border-blue-600/20 px-4 py-2 rounded-full hover:bg-blue-600 hover:text-white transition-all color-transition"
    >
      Wyczyść wszystko
    </button>
  </header>
