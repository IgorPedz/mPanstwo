    ...
    <div className="w-full divide-y-2 divide-slate-100 dark:divide-slate-800 color-transition">
      {faqs.length > 0 ? (
        faqs.map((faq, index) => {
          ...
          return (
            <div key={faq.key} className="w-full color-transition">
              <button
              ...
              >
                <span
                  className={`text-lg md:text-xl font-black tracking-tight uppercase color-transition ${
                    isOpen
                ...
                <div
                  className={`p-2 rounded-xl border-2 transition-all duration-300 ${
                    isOpen
                      ? "border-indigo-500 bg-indigo-500 text-white rotate-180"
