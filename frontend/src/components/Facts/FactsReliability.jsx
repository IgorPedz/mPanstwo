...
import { getReliability } from "../../Utils/Maps/Content.jsx";
import { useTranslation } from "react-i18next";

export default function FactsReliability() {
  const { t } = useTranslation();
  const reliability = getReliability(t);
